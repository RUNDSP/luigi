...
class CentralPlannerScheduler(Scheduler):
    ...
    def _rank(self):
        ...
        return lambda task: (task.priority, -task.time)

    def _schedulable(self, task, used_resources):
        ...
        for dep in task.deps:
            ...
            if dep_task is None or dep_task.status != DONE:
                return False
        return self._has_resources(task.resources, used_resources)
    ...
    def get_work(self, worker, host=None):
        ...
        tasks = list(self._state.get_active_tasks(worker_id=worker))
        ...
        for task in tasks:
            ...
            if not self._schedulable(task, potential_resources) or best_task:
                continue
